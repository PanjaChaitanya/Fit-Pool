  ...
  return (
    <>
      <div className=" signup-body flex items-center justify-center min-h-screen">
        <div className='signup-box flex flex-wrap it border-2 w-3xl border-amber-300 rounded-xl shadow-2xl'>
          <div className="signup-info relative w-1/2">
            <div className="round-color">

            </div>
          </div>
          <div className="form-info w-1/2 flex flex-col gap-2 items-center justify-center">
